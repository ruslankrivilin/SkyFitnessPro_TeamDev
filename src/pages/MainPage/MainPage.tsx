    ...
    <>
      <div className="">
        ...
        <div className=" flex items-center justify-between mdSc:mb-[60px]">
          <h1 className="font-medium leading-normal text-[32px] inline-block align-middle text-left md:text-pretty md:text-[60px] ">
        ...
        <div className="justify-end flex md:justify-center">
          <div
            className="rounded-buttonRadius bg-mainColor text-center font-defaultFont font-normal text-black hover:bg-mainHover px-btnX py-btnY mt-[24px] mb-[29px] md:mt-[34px] md:mb-[81px] md:flex justify-center"
